...
OBJ_TEMPL[name] = MaterialTemplate(
    name,
    description='A material pressed with a pellet press set',
    properties=[
        ATTR_TEMPL['Form'],
    ]
)
...
OBJ_TEMPL[name] = ProcessTemplate(
    ...
    parameters=[
        ...
        [ATTR_TEMPL['Furnace Rate'],RealBounds(0.,1050.,'degC')],
        ATTR_TEMPL['Duration'],
    ],
    conditions = [
        ATTR_TEMPL['Location']
...
OBJ_TEMPL[name] = ProcessTemplate(
    name,
    description='Pressing materials with pellet pressing equipment to transform into pellets',
    conditions = [
        ATTR_TEMPL['Location']
    ],
    parameters=[
